...
class PhEDExAPI:
    ...
    def requestList(self, request='', type='', approval='', decision='', group='', requested_by='', node='', create_since='', create_until='',
                    decide_since='', decide_until='', dataset='', block='', decided_by='', format='json', instance='prod'):
        """
...
if __name__ == '__main__':
    ...
    check, data = phedex_api.requestList(type='xfer', approval='mixed', group='AnalysisOps', requested_by="Bjorn Peter Barrefors", instance="prod")
